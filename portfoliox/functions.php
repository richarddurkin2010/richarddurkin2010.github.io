...
if (!function_exists('portfoliox_setup')) :
	...
	function portfoliox_setup()
	{
		...
		$portfoliox_install_date = get_option('portfoliox_install_date');
		if (empty($portfoliox_install_date)) {
			update_option('portfoliox_install_date', current_time('mysql'));
		}
	}
endif;
 ...
 * Using Google Fonts API v2 with font-display: swap to improve Core Web Vitals by preventing layout shift
 */
function portfoliox_fonts_url()
{
	...
	$font_families[] = 'Montserrat:ital,wght@0,400;0,700;0,900;1,400;1,700';
	$font_families[] = 'Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,700';
