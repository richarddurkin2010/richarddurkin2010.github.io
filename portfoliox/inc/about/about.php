...
/**
 * Pro notice text with promotional offer
 *
 */
...
?>
	<div id="mgadin-hero" class="mgadin-hero">
		<div class="mge-info-content">
			<div class="mge-info-hello">
				...
				esc_html_e('Hi buddy, ', 'portfoliox');
			...
			<div class="mge-info-desc">
				<div style="font-weight: 600; color: #d32f2f; font-size: 16px; margin-bottom: 10px;">
					🎉 <?php esc_html_e('SPECIAL NEW YEAR OFFER: 20% OFF on PortfolioX PRO!', 'portfoliox'); ?>
				</div>
				<div><?php printf(esc_html__('You\'re currently using the Free version of the PortfolioX theme. Did you know the PortfolioX PRO version is now available with an auto-setup feature? Just activate the theme and follow the auto-setup process to get your site up and running with advanced features in no time!', 'portfoliox'), $current_theme_name); ?></div>
				<div class="mge-offer" style="background: #fff3cd; padding: 12px; border-left: 4px solid #ff6b6b; margin: 12px 0; border-radius: 4px;">
					<strong style="color: #d32f2f;">⏰ <?php esc_html_e('LIMITED TIME OFFER - Valid for 7 Days Only!', 'portfoliox'); ?></strong> 
					<div class="mgeoffer-inner" style="display: flex; align-items: center; gap: 8px; margin-top: 6px;">
					<span style="font-size: 14px;"><?php esc_html_e('Use coupon code:', 'portfoliox'); ?></span>
					<code style="background: #f0f0f0; padding: 4px 8px; border-radius: 3px; font-weight: bold; color: #d32f2f; font-size: 16px;">boost20</code>
					<br><span style="font-size: 12px; color: #666;">✓ <?php esc_html_e('Auto-setup feature', 'portfoliox'); ?></span>
					<br><span style="font-size: 12px; color: #666;">✓ <?php esc_html_e('Advanced customization options', 'portfoliox'); ?></span>
					<br><span style="font-size: 12px; color: #666;">✓ <?php esc_html_e('Premium support & updates', 'portfoliox'); ?></span>
					</div>
				</div>
				<div style="color: #d32f2f; font-weight: 600; margin-top: 10px;">
					⚠️ <?php esc_html_e('Don\'t miss out! Offer expires in 7 days. Grab your discount now!', 'portfoliox'); ?>
				</div>
			</div>
			<div class="mge-info-actions">
				<a href="<?php echo esc_url($pro_link); ?>" target="_blank" class="button button-primary upgrade-btn" style="background: #d32f2f; border-color: #d32f2f; font-size: 14px; padding: 8px 16px; font-weight: bold;">
					<?php esc_html_e('🎁 Get 20% Discount Now', 'portfoliox'); ?>
				</a>
				<a href="<?php echo esc_url($demo_link); ?>" target="_blank" class="button button-primary demo-btn">
					<?php esc_html_e('View Pro Features', 'portfoliox'); ?>
				</a>
...
{
	$hide_date = get_option('portfoliox_pro_info_text7');
	if (!empty($hide_date)) {
...
function portfoliox_new_optins_texts_init()
{
	...
	if (isset($_GET['xbnotice']) && $_GET['xbnotice'] == 1) {
		update_option('portfoliox_pro_info_text7', current_time('mysql'));
	}
}
