...
<?php
		...
		public function style_and_scripts($hook_suffix)
		{
			...
			wp_enqueue_style('about-page-css', get_template_directory_uri() . '/inc/about/css/about.min.css', array(), PORTFOLIOX_VERSION, 'all');
			wp_enqueue_script('eye-notice-js', get_template_directory_uri() . '/inc/about/js/notice.js', array('jquery'), PORTFOLIOX_VERSION, true);
